...
setup(
    ...
    description = 'Fuzzy logic library containing hedges for making fuzzy database queries',   # Give a short description about your library
    ...
    keywords = ['fuzzy', 'hedge', 'query', 'database'],   # Keywords that define your package best
